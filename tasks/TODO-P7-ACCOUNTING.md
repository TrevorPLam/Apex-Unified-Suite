...
**Actor:** AGENT
**Priority:** 🟠 High
**Current State:** No QuickBooks integration exists. The finance module uses mock data only. OAuth stubs referenced by INT‑QB‑001 (stub) are not yet created.
**Size:** Large
...
- Pin Stripe API version header to `2026-04-22.dahlia` for any Stripe calls within this module; pin QBO to v3
...
**Actor:** AGENT
**Priority:** 🟡 Medium
**Current State:** No Xero integration exists. `QuickBooksAdapter` patterns from INT‑QB‑001 are available as a reference template.
**Size:** Large
