...
#### **Available Rules**
- **accessibility.md**: Accessibility guidelines and ARIA compliance
- **design-tokens.md**: Design system constants and visual identity
- **tech-stack.md**: Technology stack guidelines and version management
- **ydm-architecture.md**: Monorepo architecture and project structure
- **pnpm-workspace-patterns.md**: Workspace patterns and dependency management
- **motion-hierarchy.md**: Framer Motion animation hierarchy
- **performance.md**: Performance optimization guidelines

#### **Available Skills**
- **create-react-component**: React component creation with accessibility patterns
- **create-layout-component**: Layout component development
- **create-mock-data**: Mock data generation for development
- **codegen-workflow**: Code generation workflow management
- **monorepo-structure**: Monorepo structure guidance
...
2. **API Business Endpoints** (only health check exists)
3. **Frontend API Integration** (replace static data with real API calls)
4. **Basic Business Logic** (no CRUD operations implemented)
5. **Authentication System** (no auth exists)
6. **Testing Infrastructure** (no tests implemented)
7. **Monitoring & Analytics** (no monitoring exists)
